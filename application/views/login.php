...
<head>
    ...
    <title>Login - Website Pemesanan Gedung Pernikahan</title>
    <!-- ===== Bootstrap CSS ===== -->
        ...
        <div class="login-box">
            <div class="white-box form-horizontal form-material">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control validate" type="text" name="username" id="username" required="" placeholder="Username">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Belum punya akun? <a href="<?php echo base_url(); ?>index.php/register" class="text-primary m-l-5"><b>Registrasi</b></a></p>
                        </div>
                    </div>
                </form>
