            ...
            <div class="container">
                ...
                <div id="navbar-collapse-02" class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#gedung">List Gedung</a></li>

                        <li><a href="#prasmanan">Catering</a></li>
						
                        <li><a href="#login" class="discover-btn" onclick="location.href = '<?php echo site_url('/login'); ?>';" id="login">Login</a></li>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-item-inner">
                            ...
                            <h3 class="blog-title"><a href="<?php echo site_url('/login'); ?>"><?php echo $row['NAMA_GEDUNG']; ?></a></h3>
                            
                            <a href="<?php echo site_url('/login'); ?>" class="blog-icons"><i class="fa fa-tags"></i>ID: <?php echo $row['ID_GEDUNG']; ?></a>
                            
                            <a href="<?php echo site_url('/login'); ?>" class="blog-icons last"><i class="fa fa-user"></i><?php echo $row['KAPASITAS']; ?> Orang</a>
                            
                            <p>Quis autem velis etis reprehender etid quiste voluptate velite esse quam nihis etsa illum sedit varias netsum.</p>
                            <a href="#login" class="discover-btn" onclick="location.href = '<?php echo site_url('/login'); ?>';" id="login">Detail Gedung</a>                      
                        </div>
                        <!--end blog-item-inner -->
