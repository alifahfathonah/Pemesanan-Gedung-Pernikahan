...
$this->output->set_header('refresh:2; url='.site_url('home/pembayaran'));
?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1 text-center">
                    <p class="section-subtitle">Pembayaran Diterima</p>                    
                </div>
                <!--end col-md-12-->
            ...
            <div class="row">
                    <div class="col-lg-12" style="background: #ffffff; padding: 15px 15px; border-style: solid; border-width: 1px; border-color: #f9f9; border-radius: 10px;">
                        <p class="section-subtitle" align="center">Terima Kasih, Pembayaran Anda Akan Kami Proses Dalam Waktu 2x24 Jam</p>
                    </div>
            </div>
