        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1 text-center">
                    <p class="section-subtitle">Konfirmasi Pembayaran</p>                    
                </div>
                <!--end col-md-12-->
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                                    <?php echo form_open_multipart('pembayaran/frm_pembayaran'); ?>
                                            ...
                                            <input type="text" class="form-control" id="no_pemesanan" name="no_pemesanan" placeholder="Contoh: PMSN0021" require> </div>
                                        <div class="form-group">
                                            <label for="atas_nama">Rekening Atas Nama</label>
                                            <input type="text" class="form-control" id="atas_nama" name="atas_nama" placeholder="Contoh: Nirwansyah Ramdhani" require> </div>
                                        <div class="form-group">
                                            <label for="jumlah_transfer">Nominal Transfer</label>
                                            <input type="text" class="form-control" id="jumlah_transfer" name="jumlah_transfer" require placeholder="Contoh: 50000000"> </div>
                                        <div class="form-group">
                                            <label for="dari_bank">Bank Anda</label>
                                            <input type="text" class="form-control" id="bank_dari" name="bank_dari" require placeholder="Contoh: Mandiri, BCA"> </div>
                                        <div class="form-group">
                                            <label for="tgl_transfer">Tanggal Transfer</label>
                                            <input type="date" class="form-control" id="tgl_transfer" name="tgl_transfer" require> </div>  
                                        <div class="form-group">
                                            <label for="bukti_transfer">Upload Bukti Transfer (JPG Only)</label>
                                            <input type="file" class="form-control" id="bukti_transfer" name="bukti_transfer" require> </div>  
                                            <button type="submit" name="submit" id="submit" class="btn btn-success waves-effect waves-light m-r-10">Konfirmasi</button>
                                    </form>
