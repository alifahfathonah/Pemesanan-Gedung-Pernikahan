            ...
            <div class="container-fluid">
                <!-- /row -->
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading"> Detail Pemesanan <?php echo $hasil->ID_PEMESANAN; ?></div>
                                    ...
                                    <form class="form-horizontal" role="form">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Harga Sewa Gedung:</label>
                                                        <div class="col-md-9">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Total Harga Keseluruhan + Pajak:</label>
                                                        <div class="col-md-9">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $hasil->DESKRIPSI_ACARA; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <a href="<?php echo site_url('admin/admin_controls/delete_jadwal/'.$id_pemesanan.'')?>" onclick="return dialog();" class="btn btn-info" style="color: #ffffff;"> <i class="fa fa-pencil"></i> Hapus Acara</a>
                                                            <a href="<?php echo site_url('admin/dashboard')?>" class="btn btn-default" style="color: #000000;">Kembali</a>
                                                        </div>
                                                    </div>
                                                </div>
