                            ...
                            <div class="page-aside">
                                <div class="right-aside">
                                    <div class="right-page-header">
                                        <h3 class="box-title">Rekap Transaksi </h3> </div>
                                    <div class="clearfix"></div>
                                    <div class="scrollable">
                                        <div class="table-responsive">
                                        <p class="section-subtitle">Filter Periode Tanggal</p>
                                        <form method="get" action="<?php echo site_url('admin/rekap_transaksi/details') ?>">
                                        <div class="input-daterange input-group" id="date-range">
                                                    <input type="date" class="form-control" id="start_date" name="start_date" />
                                                    <span class="input-group-addon bg-info b-0 text-white">sampai</span>
                                                    <input type="date" class="form-control" id="end_date" name="end_date" />
                                                    </div><br />
                                                    <input type="submit" value="Proses" name="btnProses" id="btnProses" onclick=" return btnProsesAlert();" class="btn btn-outline btn-default form-control">
                                                </form>      
                                        </div>
                                    </div>
                                </div>
