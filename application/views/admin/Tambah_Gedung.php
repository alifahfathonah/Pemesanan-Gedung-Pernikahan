                            ...
                            <div class="page-aside">
                                <div class="right-aside">
                                    <div class="right-page-header">
                                        <h3 class="box-title">Tambah Gedung Baru </h3> </div>
                                    <div class="clearfix"></div>
                                    <div class="scrollable">
                                    <?php echo form_open_multipart('admin/add_gedung'); ?>
                                        <label for="no_pemesanan">Nama Gedung</label>
                                        <input placeholder="Gedung A" id="nama" name="nama_gedung" type="text" class="form-control"> </div>
                                        <div class="form-group">
                                            <label for="atas_nama">Kapasitas Gedung</label>
                                            <input placeholder="150"id="kapasitas" name="kapasitas_gedung" type="text" class="form-control"> </div>
                                        <div class="form-group">
                                            <label for="jumlah_transfer">Alamat Gedung</label>
                                            <textarea class="form-control" name="alamat_gedung"></textarea> </div>
                                        <div class="form-group">
                                            <label for="dari_bank">Deskripsi Gedung</label>
                                            <textarea class="form-control" name="deskripsi_gedung"></textarea> </div>
                                        <div class="form-group">
                                            <label for="tgl_transfer">Harga Sewa</label>
                                            <input placeholder="650,000,000"id="kapasitas" name="harga_sewa" type="text" class="form-control"> </div>
                                            <div class="form-group">
                                        <label for="tgl_transfer">Gambar Utama Gedung</label>
                                            <input class="form-control" type="file" name="img_gedung1"> </div>  
