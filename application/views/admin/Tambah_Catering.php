                            ...
                            <div class="page-aside">
                                <div class="right-aside">
                                    <div class="right-page-header">
                                        <h3 class="box-title">Tambah Catering Baru </h3> </div>
                                    <div class="clearfix"></div>
                                    <div class="scrollable">
                                    <form class="col s11" method="post" action="<?php echo site_url('admin/admin_controls/tambah_catering');?>">
                                        <label for="no_pemesanan">Nama Paket Catering</label>
                                        <input placeholder="e.g Paket Hemat 1" name="nama_paket" type="text" class="form-control"> </div>
                                        <div class="form-group">
                                            <label for="atas_nama">Menu Pembuka</label>
                                            <input placeholder="e.g Dimsum" name="menu_pembuka" type="text" class="form-control"> </div>
                                        <div class="form-group">
                                            <label for="jumlah_transfer">Menu Utama</label>
                                            <input placeholder="e.g Nasi Lemak" name="menu_utama" type="text" class="form-control"> </div>
                                        <div class="form-group">
                                            <label for="dari_bank">Menu Penutup</label>
                                            <input placeholder="e.g Dessert" name="menu_penutup" type="text" class="form-control"> </div>
                                        <div class="form-group">
                                            <label for="tgl_transfer">Harga per Porsi</label>
                                            <input placeholder="e.g 125,000" name="harga" type="text" class="form-control"> </div>
