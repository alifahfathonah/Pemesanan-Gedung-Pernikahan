            ...
            <div class="container-fluid">
                <!-- /row -->
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading"> Detail Transaksi <?php echo $details->KODE_PEMBAYARAN.$details->ID_PEMBAYARAN; ?></div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $details->KODE_PEMBAYARAN.$details->ID_PEMBAYARAN; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Bank Pengirim:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $details->BANK_PENGIRIM; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $details->KODE_PEMESANAN.$details->ID_PEMESANAN; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo "Rp.".number_format($details->NOMINAL_TRANSFER); ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $details->ATAS_NAMA; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Total Keseluruhan:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo "Rp.".number_format($details->TOTAL); ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo $details->TANGGAL_TRANSFER; ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Total Terhutang:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?php echo "Rp.".number_format($details->TOTAL-$details->NOMINAL_TRANSFER); ?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Gambar Bukti Transfer:</label>
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <img src="<?php echo $details->PATH.$details->IMG_NAME; ?>" width="400px"> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <a href="<?php echo site_url('admin/pembayaran')?>" class="btn btn-default" style="color: #000000;">Kembali</a>
                                                        </div>
                                                    </div>
                                                </div>
