                            ...
                            <div class="page-aside">
                                <div class="right-aside">
                                    <div class="right-page-header">
                                        <h3 class="box-title">List Paket Catering </h3> </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td colspan="2">
                                                            <a href="<?php echo site_url('admin/add_catering') ?>" class="btn btn-info btn-rounded" style="color:#ffffff;">Tambah Paket Catering Baru</button>
                                                        </td>
                                                        <td colspan="3">
